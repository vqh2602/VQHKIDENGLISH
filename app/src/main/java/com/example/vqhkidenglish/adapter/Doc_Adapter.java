...
public class Doc_Adapter extends RecyclerView.Adapter<Doc_Adapter.RecentlyViewedViewHolder> {

    Context context;
    List<Doc> phatamList;

    public Doc_Adapter(Context context, List<Doc> phatamList) {
...
//                context.startActivity(i);
                switch (position){
                    case 0:
                        Intent intent = new Intent(context, Doc_Voice_Activity.class);
                        intent.putExtra("key","ABC");
                        context.startActivity(intent);
                        break;
                    case 1:
                        Intent intent1 = new Intent(context, Doc_Voice_Activity.class);
                        intent1.putExtra("key","PET");
                        context.startActivity(intent1);
                        break;
                    case 2:
                        Intent intent2 = new Intent(context, Doc_Voice_Activity.class);
                        intent2.putExtra("key","WILDANIMAL");
                        context.startActivity(intent2);
                        break;
                    case 3:
                        Intent intent3 = new Intent(context, Doc_Voice_Activity.class);
